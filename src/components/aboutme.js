...
class AboutMe extends Component {
    render(){
        return(
            <div>
            <div style={{width: '100%', margin: 'auto', backgroundColor: '#004e92'}}>
               <Card shadow={100} style={{width: '100%', height: '100%', textAlign: 'center', margin: 'auto', backgroundColor: '#004e92'}} className="about-grid">
                    <CardTitle col={12}>
                        
                    </CardTitle> 
                        <CardMedia shadow={100} style={{width: '100%', height: '100%', textAlign: 'center', margin: 'auto', backgroundColor: '#004e92'}}>
                            <div className="alec-photo">
                                <img src={alec} alt="alec" className="alec-photo"/>
                                   </div>
                        </CardMedia>
                    
                    <CardText col={8} style={{width: '100%', height: '100%', textAlign: 'center', margin: 'auto',}}>
                        <div className="alec-text">
                            <p>
